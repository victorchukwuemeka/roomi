...
<section class="bg-white py-12">
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <h1 class="text-4xl sm:text-5xl text-gray-800 font-semibold">Find Your Perfect Roommate</h1>
...
<section class="bg-gray-100 py-12">
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        <div class="w-full sm:w-2/3 mx-auto p-6 bg-white rounded-lg shadow-lg">
            <h2 class="text-2xl sm:text-3xl text-gray-800 font-semibold text-center mb-4">Key Features</h2>
            <ul class="space-y-4">
                <!-- Key Features List -->
...
<div class="mx-auto p-4">
    <h2 class="text-3xl font-bold text-center mb-4 md:mb-0">{{__('Rooms Listed')}}</h2>
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        @foreach($viewData['listings'] as $listing)
        <div class="bg-white p-4 shadow-lg rounded-lg">
            <div class="relative overflow-hidden rounded-t-lg">
                <video width="320" height="240" class="object-cover rounded-t-lg" controls>
...
<section class="py-10 px-5 sm:py-10">
    <h2 class="text-3xl text-center xl:text-center font-bold mb-6">{{__('Articles On Getting a Roommate')}}</h2>
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
        ...
        <div class="bg-white shadow-lg rounded-lg overflow-hidden">
            ...
            <div class="p-4">
                ...
                <a href="{{ url('/blog/'.$article->get_id()) }}" class="block mt-2 text-blue-500 hover:underline text-sm">
                    Read More
                </a>
            </div>
        </div>
